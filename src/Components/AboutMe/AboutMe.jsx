        ...
        <>
            {language === 'es' ?
                ...
                <div className="contenedorSobreMi">
                    ...
                    <div className="contenidoSobreMi">
                        <div className=" biografia">
                            <p className="textoBiografia primerParrafo"> I'm Mariano Darío Vazquez and I grew up by the sea, in Santa Teresita, province of Buenos Aires. I hold a Ph.D. in Communication and a Bachelor's degree in Social Communication, having graduated from the Faculty of Journalism and Social Communication (FPyCS) at the National University of La Plata (UNLP).
                                I have work experience in print, radio, and digital media in the city of La Plata.</p>
                            <div className="textoBiografia segundoParrafo"> <p>I am currently working in several roles:</p>
                                <ul>
                                    <li>Undergraduate and graduate teaching at the FPyCS of the UNLP.</li>
                                    <li>Member of the help desk team in the IT area of the SCBA.</li>
                                    <li>Web Developer at <a href="https://estudiorec.com.ar" target="_blank">ESTUDIO REC</a> </li>
                                </ul>
                            </div>
