            ...
            <div className="contenedorSobreMi">
                ...
                <div className="contenidoSobreMi">
                    <div className=" biografia">
                        <p className="textoBiografia"> Mi nombre es Mariano Dario Vazquez y soy oriundo de Santa Teresita.
                            ...
                            En la actualidad me desempeño como docente de grado y posgrado en la FPyCS, en una mesa de ayuda en el área de informática de la Suprema Corte Buenos Aires (SCBA) y también soy el responsable de desarrollo web de los proyectos de <a href="https://estudiorec.com.ar" target="_blank">ESTUDIO REC</a>.</p>
                    </div>
