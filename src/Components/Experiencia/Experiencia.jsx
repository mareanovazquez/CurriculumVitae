                ...
                <div className="card">
                    <div className="contenidoExperiencia">
                        <div className="card-body">
                            <ul>
                                <li className="h6 itemExp">DIARIO HOY DE LA PLATA | <small>2011-2012</small></li>
                                <li className="subItemExp">Producción de notas y entrevistas para la sección interés general.

                                </li>
                                <li className="h6 itemExp"> RADIO ESTACIÓN SUR | <small>2011-2016</small> </li>
                                <li className="subItemExp">Columnista sobre tecnología Contenido digital para redes.

                                </li>
                                <li className="h6 itemExp">SYNTAGMA COMUNICACIÓN | <small>2014-2016</small></li>
                                ...
                                <li className="h6 itemExp">LA CUEVA DE CHAUVET | <small>2014-2022</small></li>
                                ...
                                <li className="h6 itemExp"> SUPREMA CORTE BUENOS AIRES | <small>2012-presente</small></li>
                                ...
                                <li className="h6 itemExp">ESTUDIO REC <small>2020 - presente</small></li>
