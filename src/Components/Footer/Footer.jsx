      ...
      {language === 'es' ?
        <div className='contenedorFooter'>
          ...
          <Nav variant="underline" defaultActiveKey="/home" className='contenedorContacto justify-content-center'>
            <Nav.Item>
              <Nav.Link href="mailto:marianodariovazquez@gmail.com"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
        ...
        <div className='contenedorFooter'>
          ...
          <div className='contenedorDescripcion'>
            ...
            {tituloActual === 3 && <h4 className='desarrolladorFE'>Frontend Developer</h4>}
          </div>
          ...
          <Nav variant="underline" defaultActiveKey="/home" className=' contenedorContacto justify-content-center'>
            ...
            <Nav.Item>
              <Nav.Link href="https://wa.me/5491132380400" target="_blank" >
          ...
          <div className='contenedorDescargaCV'>
            <button className='btn btn-sm btn-outline-secondary descargaCV' onClick={handleDownloadPDF}>  DOWNLOAD CV</button>
