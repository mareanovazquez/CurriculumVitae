    ...
    <>
      {language === "es" ? (
        <div className="contenedorFooter">
          <div className="contenedorNombreAlt">
            <h3>Mariano Dario Vazquez</h3>
          </div>
          <div className="contenedorDescripcion">
            {tituloActual === 1 && <h4>Licenciado en comunicación</h4>}
            {tituloActual === 2 && <h4>Docente universitario</h4>}
            {tituloActual === 3 && (
              <h4 className="desarrolladorFE">Desarrollador frontend</h4>
            )}
          </div>
          ...
          <Nav
            ...
            className="contenedorContacto justify-content-center"
          >
            <Nav.Item>
            ...
            <Nav.Item>
              <Nav.Link
                href="https://www.linkedin.com/in/mareanovazquez/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Nav.Item>
              <Nav.Link
                href="https://github.com/mareanovazquez"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <Nav.Item>
              <Nav.Link
                href="https://mareanovazquez.wordpress.com/"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="contenedorDescargaCV">
            <button
              className="btn btn-sm btn-outline-secondary descargaCV"
        ...
        <div className="contenedorFooter">
          ...
          <div className="contenedorDescripcion">
            {tituloActual === 1 && <h4>Bachelor's degree in communication</h4>}
            {tituloActual === 2 && <h4>University professor </h4>}
            {tituloActual === 3 && (
              <h4 className="desarrolladorFE">Frontend Developer</h4>
            )}
          </div>
