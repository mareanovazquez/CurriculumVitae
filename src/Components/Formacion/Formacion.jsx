    ...
    <>
      {language === "es" ? (
        <div className="contenedorFormacion">
          <div className="encabezadoFormacion">ESTUDIOS</div>
          <div className="contenidoFormacion">
            <div className="formacion">
              <ul>
                ...
                <li>
                  Licenciatura en comunicación social con orientación en
                  periodismo. Facultad de Periodismo y Comunicación Social
                  (UNLP)
                </li>
                <li>
                  Doctorado en comunicación social. Facultad de Periodismo y
        ...
        <div className="contenedorFormacion">
          <div className="encabezadoFormacion">EDUCATION</div>
          <div className="contenidoFormacion">
            <div className="formacion">
              <ul>
                <li className="titleFormacion">
                ...
                <li>
                  Bachelor's degree in Social Communication with an orientation
                  in Journalism. Faculty of Journalism and Social Communication
                  (UNLP)
                </li>
                <li>
                  Ph.D. in Social Communication. Faculty of Journalism and
                  Social Communication (UNLP)
                </li>
              </ul>
            </div>
            <div className="formacion">
